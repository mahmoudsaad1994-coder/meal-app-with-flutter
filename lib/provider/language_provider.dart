...
class LanguageProvider with ChangeNotifier {
  ...
  Map<String, Object> textsAr = {
    "start": "أبدأ الان",
    "app_description":
        "عالم الطبخ هو تطبيق عالميّ لنشر الوصفات البيتيّة يلتقي فيه محبّي الطبخ للبحث عن أفكار طبخ جديدة وتصفّح آلاف الوصفات المنزليّة",
    "drawer_name": "مطبـخنا",
    ...
    "filters_appBar_title": "صنف وجباتك",
  ...
  Map<String, Object> textsEn = {
    "start": "GET STARTED",
    "app_description":
        "Cooking World is a global application for publishing home recipes where cooking lovers meet to search for new cooking ideas and browse thousands of home recipes",
